...
public enum ModArmorMaterials implements ArmorMaterial {
    CULTIST("cultist", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(LesserOccultArtsItems.ABYSSAL_CRYSTAL));
    ...
    public String getName() {
        return LesserOccultArts.MOD_ID + ":" + this.name;
    }
